  ...
  <table role="grid" style="width: 100%">
    <thead>
      <tr>
        <td>
          <btn
            class="vancedvue-datepicker-pager-prev"
            block
            size="sm"
            style="border: none"
            @click="goPrevMonth"
        ...
        <td :colspan="weekNumbers ? 6 : 5">
          <btn
            class="vancedvue-datepicker-title"
            block
            size="sm"
            style="border: none"
            @click="changeView"
        ...
        <td>
          <btn
            class="vancedvue-datepicker-pager-next"
            block
            size="sm"
            style="border: none"
            @click="goNextMonth"
      ...
      <tr align="center">
        ...
        <td
          ...
          width="14.2857142857%"
        >
          <small class="vancedvue-datepicker-week">{{
...
const yearMonthStr = computed(() => {
  if (props.yearMonthFormatter) {
    ...
    return isExist(props.month)
      ? `${props.year} ${t(`vancedvue.datePicker.month${props.month + 1}`)}`
      : props.year;
  }
});
...
function tWeekName(index) {
  return t(`vancedvue.datePicker.week${index}`);
}
