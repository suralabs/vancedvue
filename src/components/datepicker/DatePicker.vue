    ...
    <div v-if="todayBtn || clearBtn">
      ...
      <div class="text-center">
        <btn
          ...
          size="sm"
          @click="selectToday"
          >{{ t('vancedvue.datePicker.today') }}</btn
        >
        <btn
          v-if="clearBtn"
          data-action="select"
          ...
          size="sm"
          @click="clearSelect"
          >{{ t('vancedvue.datePicker.clear') }}</btn
        >
      </div>
    </div>
  </div>
...
const pickerClass = computed(() => {
  return {
    'vancedvue-datepicker': true,
    'vancedvue-datepicker-date': view.value === 'd',
    'vancedvue-datepicker-month': view.value === 'm',
    'vancedvue-datepicker-year': view.value === 'y',
  };
});
